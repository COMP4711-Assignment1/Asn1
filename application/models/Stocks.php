...
class Stocks extends CI_Model {
	var $data = array(
		array('id' => '1', 'who' => 'Gold', 'mug' => 'gold.png', 'where' => '/stock/1',
			'what' => '$1000', 'one' => 'Gold', 'two' => 'Oil', 'three' => 'Bonds', 'four' => 'Grain',
			'five' => 'Industrial', 'six' => 'Technology'),
		array('id' => '2', 'who' => 'Oil', 'mug' => 'oil.png', 'where' => '/stock/2',
			'what' => '$500', 'one' => 'Gold', 'two' => 'Oil', 'three' => 'Bonds', 'four' => 'Grain',
			'five' => 'Industrial', 'six' => 'Technology'),
		array('id' => '3', 'who' => 'Bonds', 'mug' => 'bonds.jpg', 'where' => '/stock/3',
			'what' => '$600', 'one' => 'Gold', 'two' => 'Oil', 'three' => 'Bonds', 'four' => 'Grain',
			'five' => 'Industrial', 'six' => 'Technology'),
		array('id' => '4', 'who' => 'Grain', 'mug' => 'grain.jpg', 'where' => '/stock/4',
			'what' => '$100', 'one' => 'Gold', 'two' => 'Oil', 'three' => 'Bonds', 'four' => 'Grain',
			'five' => 'Industrial', 'six' => 'Technology'),
		array('id' => '5', 'who' => 'Industrial', 'mug' => 'industrial.jpg', 'where' => '/stock/5',
			'what' => '$2000', 'one' => 'Gold', 'two' => 'Oil', 'three' => 'Bonds', 'four' => 'Grain',
			'five' => 'Industrial', 'six' => 'Technology'),
